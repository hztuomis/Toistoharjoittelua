...
public class Tiedosto {
     ...
     *
     * @return tiedostokahva kahva tiedostoon
...
//===================================================== 
    ...
    /**
     * Käy läpi tiedoston rivit; virhetilanne, jos tiedostoa ei saada avatuksi
     *
     * @return valmiiksi päivitetty sanajoukkolista kutsuvalle ohjelmalle
     *
     * ***************************************************************
     ...
     */
    public Sanajoukkolista lisaaTiedostonSanapariTrimmattunaJoukkolistaan(
            String rivi) {
        int pos = rivi.indexOf("/"); //ensimmäisen kauttaviivan positio
        if (pos < 0) {
            return joukkolista; // <<<<<<<< virhe, poistutaan!
        }
