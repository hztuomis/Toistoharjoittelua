...
public class Ohjaus {
    ...
    /**
     * Ohjelmasilmukka sanajoukkolistan tietojen syöttämiseksi. Lopetetaan,
     * jos annetaan tyhjä kysymys tai vastaus
     */
     ...
     * käyttäjän antama tieto siitä, montako sanakohtaista oikeaa vastausta
     * vaaditaan, jotta sana katsottaisiin osatuksi. Käynnistetään myös
     * virheiden tilastointi ennen uutta kyselykierrosta
     *
     * @param jl    Sanajoukkolista   
     * @return      true, jos jatketaan uudella kirroksella;
     *              muuten false
     */
     ...
     * (Arpomista ei suoriteta tässä metodissa vaan arvottu 
     * järjestysnumero tulee parametrina.)
     *
     ...
     *
     * Huom. oikeiden vastausten lukumäärä sanakohtaisesti on aina korkeintaan
     * 'perakkaisiaOikeitaVastauksiaVaaditaan'
     * 
     * @param jl        käsiteltävä sanajoukkolista
     * @param avain     kysymys-stringin arvo
     * @param perakkaisiaOikeitaVastauksiaVaaditaan     rajaarvo, joka
     *                  ohjaa, kysytäänkö sanaa vielä
     */
    ...
    /**
     * Kysytään käyttäjältä ohjaava parametriarvo, montako peräkkäistä oikeaa
     * vastausta kysymykseen on saatava, ennen kuin se katsotaan osatuksi. Luvut
     * 1 - 3 kelpaavat.
     *
     ...
     * Listalla on myös virheiden lukumäärä. Listan järjestys on käänteinen, ts.
     * eniten virheellisiä vastauksia saanut kysymys on listan alussa.
     *
     * @param jl        käsiteltävä sanajoukkolista
     */
     ...
     * @param perakkaisiaOikeitaVastauksiaVaaditaan peräkkäisten oikeiden
     * vastausten vaadittu minimilukumäärä. huom. väärä vastaus nollaa 
     * oikeiden vastausten laskurin ja minimilukumäärää täytyy alkaa 
     * tavoitella alusta alkaen
     * @return      true, jos vielä on kyseltäviä sanoja; 
     *              false jos kaikki sanat on jo käsitelty
     */
    ...
    /**
     * Kysytään käyttäjältä sanan vastinetta ja tarkastetaan, menikö oikein
     *
